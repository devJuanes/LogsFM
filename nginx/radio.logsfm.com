# Nginx configuration for radio.logsfm.com
# Radio streaming subdomain with Icecast proxy

server {
    listen 80;
    listen [::]:80;
    server_name radio.logsfm.com;
...
server {
    ...
    # Logs
    access_log /var/log/nginx/radio.logsfm.com.access.log;
    error_log /var/log/nginx/radio.logsfm.com.error.log;

    # Root directory for radio subdomain Next.js build
